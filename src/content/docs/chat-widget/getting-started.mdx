...
| `opponentUserId`  | `string \| string[]` | _(Optional)_ User id(s) to create chat with. Must be a User Id from your system, similar to **userId** prop                                 |
| `type`            | `string`             | Type of chat to create if not exist: 1on1 or group                                                                                          |
| `name`            | `string`             | _(Optional)_ Name of chat                                                                                                                    |
| `photo`           | `string`             | _(Optional)_ Chat photo                                                                                                                     |
| `metadata`        | `object`             | _(Optional)_ Chat metadata                                                                                                                  |
