...
description: Step-by-step guide to sending your first chat message using ConnectyCube Cordova Chat SDK - what exactly to do when you want to build a chat.
head:
  - tag: title
    content: Send first chat message guide | ConnectyCube Cordova SDK
sidebar: 
